# Generated by Powerlevel10k configuration wizard on 2023-05-22 at 13:52 MST.
...
function prompt_my_cpu_temp() {
  ...
  if (( cpu_temp >= 80 )); then
    ...
    p10k segment -s HEAT -f green -t "${cpu_temp}"$'\uE339' -i $'\uE350'
  elif (( cpu_temp < 50 )); then
    p10k segment -s COOL -f cyan -t "${cpu_temp}"$'\uE339' -i $'\uE350'
  fi
}
