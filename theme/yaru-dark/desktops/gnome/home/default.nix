...
in {
  ...
  dconf.settings = {
    ...
    "org/gnome/desktop/background" = {
      picture-uri = "${pkgs.custom-wallpapers}/hollow-knight.jpg"; #/warty-final-ubuntu.png;
      picture-uri-dark = "${pkgs.custom-wallpapers}/hollow-knight.jpg"; #/ubuntu-wallpaper-d.png";
    };
