...

{
  ...
  home = {
    file = {
      ".config/gtk-4.0/gtk-dark.css".source = "${pkgs.yaru-theme}/share/themes/Yaru-dark/gtk-4.0/gtk-dark.css";
      ".config/gtk-4.0/assets".source = "${pkgs.yaru-theme}/share/themes/Yaru-dark/gnome-shell";
      ".config/assets".source = "${pkgs.yaru-theme}/share/themes/Yaru-dark/gnome-shell";
    };
    pointerCursor = {
      name = "Yaru";
